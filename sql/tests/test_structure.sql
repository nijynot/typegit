...
--
-- Host: localhost    Database: test_diary
-- ------------------------------------------------------
...
--
-- Current Database: `test_diary`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `test_diary` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
